            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Doctors Available</h4>
                                        ...
                                        while ($row = $res->fetch_object()) {
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../admin/his_admin_view_single_employee.php?doc_id=<?php echo $row->doc_id; ?>&&doc_number=<?php echo $row->doc_number; ?>"
